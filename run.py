...
# Else statement that will print out if the user inputs
# something other than a number higher than one.
else:
...
# Else statement in case the user makes an error with the input.
        ...
        # This makes the loop continue so that
        # the game wouldn't have to restart.
        continue
...
# This prevents the issue of printing out "Completed in 1 attemptS"
# to make the english correct,
if attempts == 1:
    print("It took you 1 attempt to guess the right number, great job!")
else:
    print("It took you", attempts, "attempts to guess the right number!")
